...
- **Inventory** — manage stock across named storage locations, created one by one or generated as a whole grid of rows and bins; record receipts, issues, transfers, and adjustments; see which parts each location (and its sublocations) holds
