                          ...
                          <tr key={item.id} className="border-b border-slate-100 last:border-b-0">
                            ...
                            <td className="px-3 py-2">
                              <LocationTreeSelect
                                ...
                                onSelectedIdChange={(locationId) => setReceiveRows((prev) => {
                                  const next = new Map(prev);
...
const locationSelectButtonClassName =
  ...
  return (
    <div ref={containerRef} className="relative w-44">
      <button
        ...
        className={locationSelectButtonClassName}
        type="button"
        onClick={() => (isOpen ? setIsOpen(false) : openSelect())}
        onKeyDown={handleKeyDown}
      >
        <span className={currentSelectedLocation ? "truncate" : "text-slate-400"}>
          {currentSelectedLocation?.name ?? copy.chooseLocation}
        </span>
              ...
              <div className="flex min-h-0 w-full flex-col">
                <div className="border-b border-slate-200 p-2">
                  ...
                  <input
                    ...
                    placeholder={copy.searchLocations}
                    type="search"
                    value={searchQuery}
    ...
    <li>
      ...
      >
        ...
        {canSelect ? (
          ...
          <span className="px-2 py-1.5 text-sm text-slate-400 truncate">{location.name}</span>
        )}
      </div>
