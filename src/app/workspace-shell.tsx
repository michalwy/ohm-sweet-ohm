      ...
      <div className="flex h-full min-h-0">
        <aside className="flex h-full w-60 shrink-0 flex-col border-r border-[var(--color-border)] bg-[var(--color-bg-elevated)]">
          ...
          >
            ...
            <Link
              className={getNavLinkClass(activeNavItem === "designs")}
              href={`/w/${workspaceSlug}/designs`}
            ...
            <Link
              className={getNavLinkClass(activeNavItem === "settings-display")}
              href={`/w/${workspaceSlug}/settings/display`}
              aria-current={
                activeNavItem === "settings-display" ? "page" : undefined
              }
            >
              {copy.display}
            </Link>
