...
const copy = {
  ...
  convertToOrderBody: "Choose a destination and select a supplier or existing draft order.",
  supplier: "Supplier",
  ...
  chooseExistingOrder: "Choose an order",
  noDraftOrders: "No draft orders available. Switch to \"New order\" to create one.",
