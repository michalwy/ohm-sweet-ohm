...
const copy = {
  ...
  additionalCostsEmpty: "No additional costs",
  additionalCostsLockedNotice: "Additional costs are locked once any item on this order has been received.",
  addAdditionalCost: "Add cost",
  addAdditionalCostTitle: "Add cost",
  editAdditionalCost: "Edit cost",
  editAdditionalCostTitle: "Edit cost",
  costLabel: "Label",
  costLabelPlaceholder: "e.g. Shipping",
  costAmount: "Amount",
  costAmountGross: "Gross amount",
  removeCost: "Remove",
  removeAdditionalCostConfirmBody: "This cost will be removed from the order.",
  additionalCostAddedToast: "Cost added",
  additionalCostUpdatedToast: "Cost updated",
  additionalCostRemovedToast: "Cost removed",
  ...
  filterOrderedAt: "Ordered date",
  filterReceivedAt: "Received date",
  filterTotalValue: "Total net value",
