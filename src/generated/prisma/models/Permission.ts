...
export type PermissionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "description" | "createdAt", ExtArgs["result"]["permission"]>
...
export interface PermissionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const permissionWithKeyOnly = await prisma.permission.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Permissions and only return the `key`
   * const permissionWithKeyOnly = await prisma.permission.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Permissions and only return the `key`
   * const permissionWithKeyOnly = await prisma.permission.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
