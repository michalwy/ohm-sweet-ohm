...
This repository contains a Next.js App Router application with TypeScript, Tailwind CSS, Prisma, PostgreSQL, Better Auth authentication, workspace routing, workspace-scoped access control, parts, and part categories.
...
- Prisma migrations for authentication, workspace access control, parts, and part categories.
- Browser-level e2e coverage for authentication, workspace creation, parts, and category management flows.
